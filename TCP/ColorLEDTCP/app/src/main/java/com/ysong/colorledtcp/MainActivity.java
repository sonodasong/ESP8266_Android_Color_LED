    ...
    class ConnectThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                threadToastShow("Connect TCP Success");
            } catch (Exception e) {
    ...
    protected void onStart() {
        ...
        seekRed.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
                try {
                    pw.println("R" + toHex(progresValue));
                } catch (Exception e) {
        ...
        seekGreen.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
                try {
                    pw.println("G" + toHex(progresValue));
                } catch (Exception e) {
                    toastShow(e.toString());
                }
            }
        ...
        seekBlue.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
                try {
                    pw.println("B" + toHex(progresValue));
                } catch (Exception e) {
                    toastShow(e.toString());
                }
            }
        ...
        seekHue.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
                try {
                    pw.println("H" + toHex(progresValue));
                } catch (Exception e) {
                    toastShow(e.toString());
                }
            }
